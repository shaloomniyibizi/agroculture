				...
				<div class="py-4 text-gray-500 ">
					...
					<ul class="mt-6">
						<li class="relative px-6 py-3">
							<span
								class="absolute inset-y-0 left-0 w-1 bg-primarycolor rounded-tr-lg rounded-br-lg"
								aria-hidden="true"
							></span>
							<a
					...
					<ul>
						...
						<li class="relative px-6 py-3">
							...
							>
								...
								<span class="ml-4">Pay Offline</span>
							</a>
						</li>
					</ul>
				</div>
			...
			<div class="flex flex-col flex-1 w-full">
							...
							<li class="relative">
								...
								<template x-if="isNotificationsMenuOpen">
									<ul
										...
										@keydown.escape="closeNotificationsMenu"
										class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:text-gray-300"
									>
										<li class="flex">
											<a
							...
							<li class="relative">
								...
								>
									<img
										...
										src="customer_images/<?=$customer_image; ?>"
										alt=""
										aria-hidden="true"
									/>
								</button>
								<template x-if="isProfileMenuOpen">
									...
									>
										...
										<li class="flex">
											<a
												class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800"
												href="index.php?change_pass" >
												<i class="fa fa-key w-4 h-4 mr-3" aria-hidden="true"></i>
										...
										<li class="flex">
											<a
												class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800"
												href="index.php?delete_account" >
												<i class="fa fa-trash w-4 h-4 mr-3"></i>
				...
				<main class="h-full overflow-y-auto">
					<div class="container px-6 mx-auto grid">
						...
						<!-- CTA -->
						<a
							class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-primarycolor rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
							href="#"
						>
						...
						<?php
							if(!isset($_GET['my_orders']) && !isset($_GET['pay_offline']) && !isset($_GET['edit_account']) && !isset($_GET['change_pass']) && !isset($_GET['delete_account']) && !isset($_GET['my_wishlist']) && !isset($_GET['delete_wishlist'])){ ?>
								<ul class="mt-6 grid gap-16 md:grid-cols-2 lg:grid-cols-3 place-items-center">
									<?php getProducts();  ?>
								</ul><?php
							}
